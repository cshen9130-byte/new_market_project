...
class FofSubFundDeals(BaseRequest):
    ...
    def set_params(self, code, page=1, page_size=50, start_date=None, end_date=None):
        self['code'] = code
        self['page'] = page
...
class FundsCompanyFields(BaseRequest):
    """私募公募基金获取团队字段配置数据"""
    _uri = "/funds/company/fields"

    def set_params(self, reg_code, type_):
        self['reg_code'] = reg_code
        self['type'] = type_


class FundView(BaseRequest):
    """私募基金业绩指标"""
    _uri = "/fund/view"

    def set_params(self, register_number, pt, type_=None, sd=None, ed=None, cycle=None, refer=None, refer_type=None):
...
class CompanyStrategyBatchSave(BaseRequest):
    """ 基金团队策略编辑 """
    _uri = "/company/strategy/batch/save"
    _method = "POST"
    _sign_params = False
    _url_concat_sign = True

    def set_params(self, _type, code, strategy_one, strategy_two=None, strategy_three=None):
        self['type'] = _type
        self['code'] = code
        self['strategy_one'] = strategy_one
        if strategy_two:
