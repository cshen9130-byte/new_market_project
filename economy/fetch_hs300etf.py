...
def extract_series(csd_result):
    """Extract a single time series from the EmQuant c.csd result object."""
...
def main():
    ...
    try:
        ...
        output_file = output_dir / "hs300etf_originalunit_2000_2026.csv"
        ...
        with output_file.open("w", newline="", encoding="utf-8-sig") as f:
            ...
            for dt, val in zip(dates, values):
                writer.writerow([format_date(dt), "510300.SH", "ORIGINALUNIT", val])
