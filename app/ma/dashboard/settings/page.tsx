  ...
  return (
    <div>
      ...
      <p className="text-xs text-zinc-500 dark:text-zinc-400 mb-6">
        将抓取邮箱关联到一个或多个账户后，仅这些账户能在「直投产品」中看到该邮箱抓取的产品。该设置不影响「邮箱运维池」。设为「全部账户不可见」后任何账户（含管理员）都看不到该邮箱的直投产品。新增加的邮箱默认「全部账户不可见」。也可设为「全部账户可见」。列表包含「抓取邮箱设置」中的账户，以及已产生净值/估值数据的邮箱。
      </p>
