...
export async function GET(req: Request) {
  ...
  const futScript = path.join(process.cwd(), "scripts/ma/get_cffex_index_futures_near_range.py")
  ...
  for (const code of codes) {
    ...
    try {
      ...
      console.log("[basis-near-ts] inputs", code, dbg)
    } catch {}
  }
  ...
  try {
    ...
    console.warn("[basis-near-timeseries] failed to write cache:", (e as any)?.message)
  }
