...
import { resolveFofMonthlyProductNavRange } from "@/lib/server/fof-monthly-report"
...
export async function GET(req: Request) {
  ...
  try {
    const range = await resolveFofMonthlyProductNavRange(product_name, beian_hao || undefined)
